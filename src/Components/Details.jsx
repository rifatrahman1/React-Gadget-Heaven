...
const Details = () => {
    ...
    useEffect(() => {
        ...
        const isExist = favorite.find((item) => item.id === gadget.id);
        if (isExist) {
            set_disable(true);
        }
    }, [data, gadget_id]);
    ...
    return (
        <div className="flex items-center gap-8 bg-white shadow p-8 rounded-3xl -translate-y-52">
            <div>
            ...
            <div>
                ...
                <div className="flex items-center gap-6">
                    ...
                    <button disabled={disable} onClick={() => handle_add_wishlist(gadgets)} className="border border-[#09080F0D] p-2 cursor-pointer rounded-full mt-5">
