        ...
        <>
            ...
            <div className={`${headerBg} flex flex-col justify-center mt-8.5`}>
                ...
                <div className="flex items-center gap-6 text-center justify-center mt-8">
                    <NavLink to={'/dashboard/cart'} className={({ isActive }) => (isActive ? 'px-16 py-[13px] border border-white rounded-4xl text-white' : 'px-16 py-[13px] bg-white rounded-4xl text-[#9538E2] text-[18px] font-extrabold')}>Cart</NavLink>
